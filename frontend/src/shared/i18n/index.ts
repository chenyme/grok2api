...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  testAll: "Check all", testAllHelp: "Check every configured proxy node now, including disabled nodes. Failed nodes are removed and their account bindings are repaired; source sync may import a removed node again.",
  ...
  sourceSaved: "Subscription saved", sourceDeleted: "Subscription deleted", sourceSynced: "Subscription synced: {{imported}} imported, {{skipped}} invalid or duplicate, {{filtered}} filtered out",
  ...
  editSource: "Edit subscription", subscriptionURL: "Subscription URL", sourceDialogDescription: "Configure the source, refresh schedule, and optional country or latency checks before nodes are saved.",
...
Object.assign(resources["zh-CN"].translation.settings.egress as unknown as Record<string, string>, {
  ...
  batchDeleteSourceHint: "其中 {{count}} 个节点由代理来源管理，下次同步时可能重新创建。",
	...
	sourceDialogDescription: "配置订阅来源、刷新周期，以及写入前的国家和延迟筛选。",
