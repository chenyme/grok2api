...
Object.assign(resources.en.translation.settings.egress as unknown as Record<string, string>, {
  ...
  testAll: "Check all", testAllHelp: "Check every configured proxy node now, including disabled nodes, and update its health status.",
...
Object.assign(resources["zh-CN"].translation.settings.egress as unknown as Record<string, string>, {
  ...
  accounts: "已绑定",
  testAll: "检测全部",
  testAllHelp: "立即检测所有已配置的代理节点（包括停用节点），并更新健康状态。",
  rebalance: "均衡分配",
