  ...
  "zh-CN": {
    translation: {
      ...
      qualityGuard: {
        ...
        unavailable: "质量守护尚未连接", unavailableHelp: "根 Compose 已自动挂载状态卷。首次启用请在仓库根目录执行 sh docker/quality-guard-up.sh；脚本会创建守护配置、启动 sidecar，并把实时状态显示在这里。", testComplete: "检测完成：{{speed}}",
